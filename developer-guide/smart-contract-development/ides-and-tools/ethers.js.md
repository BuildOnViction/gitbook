...
To test out the examples in this guide on Viction [mainnet]($HOME/../../developer-guide/working-with-viction/viction-mainnet.md) or [testnet](../../../developer-guide/working-with-viction/viction-testnet.md), you will need to have the corresponding RPC API endpoints and some native VIC tokens.
