...
To test out the examples in this guide on Viction [mainnet](../../working-with-viction/viction-mainnet.md) or [testnet](../../../archive/viction-testnet.md), you will need to have the corresponding RPC API endpoints and some native VIC tokens.
