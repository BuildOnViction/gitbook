...
Look at the [Viction Networks](https://github.com/DucDuongCoin98/Viction\_VI/blob/main/developer-guide/working-with-Viction/README.md) page to get more information of the Viction Testnet/Mainnet RPC network.
