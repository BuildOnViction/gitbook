...
5\. Let’s now connect MetaMask to Viction (testnet). Click the menu with the “Main Ethereum Network” and select **Custom RPC**. Use the [Networks data from Viction](../../vn-readme/how-to-connect-to-viction-network/metamask.md) (testnet) and click **Save**
