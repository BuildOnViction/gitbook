---
description: This guide will show you how to confirm a project on Vicscan
---
...
* The contract will be confirmed with the status “**Project Confirmed**” <img src="../.gitbook/assets/image (149).png" alt="" data-size="line"> on [VicScan](https://www.vicscan.xyz/), verifying that the contract belongs to the officially recognized project.
* If both the project is confirmed and the [contract is verified](how-to-verify-a-contract-on-vicscan.md), the contract status will be updated to <img src="../.gitbook/assets/image (148).png" alt="" data-size="line">
